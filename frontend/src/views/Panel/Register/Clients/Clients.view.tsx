...
import { useLogic } from "./Clients.logic";
import UpsertClientModal from "./UpsertClientModal/UpsertClientModal.view";

const RegisterClientsView = () => {
          ...
          <div className="mb-8 flex items-center justify-between gap-8">
            ...
            <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
              <button
                ...
                type="button"
                onClick={() => {
                  methods.setModalClient(undefined);
