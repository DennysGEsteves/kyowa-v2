...
import { useLogic } from "./Suppliers.logic";
import UpsertSupplierModal from "./UpsertSupplierModal/UpsertSupplierModal.view";

const RegisterSuppliersView = () => {
          ...
          <div className="mb-8 flex items-center justify-between gap-8">
            ...
            <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
              <button
                ...
                type="button"
                onClick={() => {
                  methods.setModalSupplier(undefined);
...
export default RegisterSuppliersView;
